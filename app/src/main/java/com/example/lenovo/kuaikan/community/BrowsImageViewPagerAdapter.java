...
import com.example.lenovo.kuaikan.utils.WindowUtil;
 ...
 */
class BrowsImageViewPagerAdapter extends PagerAdapter {
    private Context context;
    private List<String> images;
    private SparseArray<View> cacheView;
    private ViewGroup containerTemp;

    public BrowsImageViewPagerAdapter(Context context, List<String> images) {
    ...
    public Object instantiateItem(final ViewGroup container, int position) {
        ...
        if(view == null){
            view = LayoutInflater.from(context).inflate(R.layout.brows_image_item,container,false);
            view.setTag(position);
            GlideImageView image = (GlideImageView) view.findViewById(R.id.glideimageview);
