...
public class CommentModel implements ICommentModel {
    ...
    @Override
    public void getServerData(String feedId, String type, String firstId, final Callback<CommentBean> beanCallback) {
    ...
    @Override
    public void getComicsComment(String feedId, String type, String firstId, final Callback<CommentBean> beanCallback) {
        final ReqComment req = new ReqComment();
