...
//    获取社区评论
    void getServerData( String feedId,String type,String firstId ,Callback<CommentBean> beanCallback );
//    获取漫画页面评论
    void getComicsComment(String feedId,String type,String firstId ,Callback<CommentBean> beanCallback);
}
