...
/**
 * Created by Zhanglibin on 2017/4/21.
 */

public class FooterBehaviorUp extends CoordinatorLayout.Behavior<View> {
    ...
    public FooterBehaviorUp(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
